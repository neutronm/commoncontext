/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: bcd9ee39febfc2b3e31f5f59f5ef8756)
...
interface __BaseEnv_CloudflareEnv {
	...
	DEMO_TOKEN_FRED: string;
	DEMO_TOKEN_SARA: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "DEMO_TOKEN_FRED" | "DEMO_TOKEN_SARA">> {}
}
