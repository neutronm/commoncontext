...
export function ContextActions({
  ...
  const availability = contextActionAvailability(object, viewerName);
  const hasMutableLifecycle =
    object.lifecycleStatus === "pending" ||
    object.lifecycleStatus === "active";
  const canProposeChange =
    availability.canProposeChange && hasMutableLifecycle;
  const canRespond = availability.canRespond && hasMutableLifecycle;
